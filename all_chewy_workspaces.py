...
def main():
    regions = ["us-east-1", "us-west-2", "ap-northeast-1"] #"us-east-1", "us-west-2", "ap-northeast-1"
    filename = input("Enter the filename: ") + ".csv"
    directory = input("Enter the file path you like this exported to: ")
    retry_count = 0
    accounts = ["557431213659", "526793762506", "933881799506", "557431213659", "665636888158"]
